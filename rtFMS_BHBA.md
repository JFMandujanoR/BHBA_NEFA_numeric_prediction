...
In order to compare the different branches of the tree we can consult this [table](https://github.com/JFMandujanoR/QCheck_Prediction_Report/blob/master/dat1_BHBA.xlsx). 
